...
# Set Vars
$global:license = Get-Content -Path ".\PowerServer-Installer\LICENSE.txt" -Raw
...
@(
    "Stable Install - Use the most reliable version."
) | ForEach-Object {
...
$global:startAfterInstall.Content = "Start after installation"
...
$global:nextButton.Add_Click({
    if ($global:langDropDown.Visibility -eq "Visible") {
        ...
        $folderconfirm = [System.Windows.Forms.MessageBox]::Show("Are you sure you want to install PowerServer to $($global:folderPath.Text)\PowerServer?", "Confirm Installation", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Question)
        ...
        Start-Process -FilePath "powershell.exe" -ArgumentList @(
            ...
            "-NoProfile",
            "-File", ".\PowerServer-Installer\bin\initiate.ps1",
            "-Path", "`"$($global:Path)`"",
...
$global:Window.Add_Loaded({
    ...
    $global:Window.Title = "PowerServer Installer"
    $global:langDropDown.Visibility = "Visible"
})
